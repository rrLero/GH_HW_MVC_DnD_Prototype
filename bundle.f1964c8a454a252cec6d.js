...
const cartList = {
    ...
    get: index => {
        ...
        return cartList.cartList.filter(el => el.stuff.id === index)[0];
    },
    ...
    trigger: (event, args = []) => {
        cartList.callbacks.forEach(item => {
            if (item.event === event) {
                item.callback.apply(undefined, args);
            }
        });
    }
...
const stuffList = [{
    image: 'http://mirpozitiva.ru/uploads/posts/2016-08/1472058016_02.jpg',
    name: 'first',
    price: 100,
    id: 1
}, {
...
// module
exports.push([module.i, ".stuff-list {\n  display: flex;\n  padding: 0;\n  margin: 0;\n  justify-content: space-evenly;\n  flex-basis: 100%;\n}\n.stuff {\n  display: flex;\n  flex-wrap: wrap;\n  max-width: 200px;\n  justify-content: space-evenly;\n}\n.stuff__img {\n  flex-basis: 100%;\n}\n.stuff__img_img {\n  user-select: none;\n  width: 100%;\n  height: 100%;\n  cursor: -webkit-grabbing;\n  transition: transform 500ms;\n}\n.stuff__name {\n  text-transform: capitalize;\n  font-weight: bold;\n}\n.stuff_draggable {\n  opacity: 0.3;\n}\n.cart-table {\n  border: 1px solid black;\n}\n.draggable {\n  position: absolute;\n  transition: transform 300ms;\n}\n.draggable_move {\n  transform: scale(0.5);\n  transition: transform 300ms;\n}\nbody {\n  height: 100vh;\n}\n", ""]);
...
var _cartController = __webpack_require__(337);

var _stuffController = __webpack_require__(339);

(0, _cartController.cartController)();
(0, _stuffController.stuffController)();
...
var _cartView = __webpack_require__(338);

var _cartList = __webpack_require__(125);

const cartController = () => {
    (0, _cartView.cartView)('#cart-table', _cartList.cartList);
};
...
const cartView = (selector, cartList) => {
...
exports.stuffController = undefined;

var _stuffList = __webpack_require__(126);

var _stuffListView = __webpack_require__(340);

const stuffController = () => {

    (0, _stuffListView.stuffListView)('#stuff-list', _stuffList.stuffList);
};
...
exports.stuffListView = undefined;

var _draggable = __webpack_require__(341);

const stuffListView = (selector, stuffList) => {
        ...
        if (template && template.parentNode) {
            ...
            stuffList.forEach(stuff => {
                ...
                if (src instanceof HTMLImageElement && name && price && img) {
                    ...
                    img.addEventListener('mousedown', _draggable.draggable);
                }
...
exports.stuffListView = stuffListView;
...
const setTopLeftCords = (helperOffsetTop, helperOffsetLeft, event, clone) => {
...
const draggable = event => {
    ...
    const mouseupHandler = () => {
        const currentStuff = stuff ? _stuffList.stuffList[+stuff.getAttribute('data-id') - 1] : _stuffList.stuffList[0];
        if (prevCart) {
            if (_cartList.cartList.get(currentStuff.id)) {
                _cartList.cartList.addQuantity(currentStuff.id, 1);
            } else {
                _cartList.cartList.add({
                    stuff: currentStuff,
                    quantity: 1
                });
            }
